...
from keras.layers import Input,Activation,Dense,Flatten,Reshape,Conv2D,Conv2DTranspose,Dropout,BatchNormalization,UpSampling2D,LeakyReLU
...
x_train=x_train[np.isin(y_train,[7])] # 7번 부류로 학습
